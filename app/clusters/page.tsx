  ...
  return (
    <div className=" w-full">
      <div className="w-full rounded-b-3xl flex flex-col items-center justify-center gap-10 p-6 pb-10 bg-[linear-gradient(180.87deg,#FFFFFF_8.49%,#F1F6F8_77.17%,#4083A2_249.31%,#D0E0E8_249.31%)] relative">
        ...
        <p className="max-w-prose text-center text-neutral-600 text-lg z-2000">
      ...
      <div className="mt-20 md:mt-30 bg-[radial-gradient(26.11%_37.23%_at_27.63%_41.06%,#FFFFFF_31.58%,_rgba(255, 255, 255, 0)_99.91%)]">
        <div className="flex flex-col items-center gap-4">
          ...
          <Carousel className="w-full px-10">
            <div className="flex flex-col">
              <CarouselContent className="-ml-4 flex gap-4 w-full">
                {CarouselData.map((item, key) => (
                  <CarouselItem
                    className=" md:basis-1/3 md:aspect-5/4 aspect-square border-none border-2 ml-4 rounded-2xl relative md:pl-0"
                    key={key}
                  >
                    <img
                      ...
                      src={item.img}
                    />
                    <Collapsible className="group rounded-md data-open:bg-muted self-end absolute md:bottom-2 bottom-8 left-6 bg-white w-[90%] md:w-[80%] md:left-10">
                      <CollapsibleTrigger className="flex justify-between w-full px-2 flex-col items-center md:pt-0">
                        <div className="w-full flex justify-between items-center">
                          <p className="md:text-sm lg:text-lg">{item.title}</p>
                      ...
                      <CollapsibleContent className="flex flex-col items-start gap-2 pt-1 px-2 md:px-0 md:pl-2 lg:px-2 md:text-sm group-data-[state=open]:transition-transform duration-400 justify-between py-4 md:py-0">
                        <p className="md:text-[10px] text-[12px] lg:text-sm lg:leading-4 md:leading-3.5">
                          {item.content}
                        </p>
                        <Link
